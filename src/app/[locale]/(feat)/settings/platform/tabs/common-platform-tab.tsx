		...
		<div className='mt-6 space-y-6 fade-in'>
			...
			{showDownloadCheckInterval && (
				<FormField
					...
					render={({ field }) => (
						<FormItem>
							<FormLabel>{strings.downloadIntervalCheckTitle}</FormLabel>
							<FormControl>
								<Input
									placeholder='60'
									type={"number"}
							...
							<FormDescription>{strings.downloadIntervalCheckDescription}</FormDescription>
							<FormMessage />
						</FormItem>
					)}
				/>
				...
				<FormField
					...
					render={({ field }) => (
						<FormItem>
							...
							<FormDescription>{strings.fetchDelayDescription}</FormDescription>
							<FormMessage />
						</FormItem>
					)}
				/>
				...
				<FormField
					...
					render={({ field }) => (
						<FormItem>
							...
							<FormDescription>{strings.partDescription}</FormDescription>
							<FormMessage />
						</FormItem>
					)}
				/>
