		...
		return (
			...
			>
				...
				{showForceOrigin && (
					<FlagFormField
						control={control}
						fieldName={"forceOrigin"}
						controlPrefix={controlPrefix}
						title={strings.forceOrigin}
						description={strings.forceOriginDescription}
					...
					render={({ field }) => (
						<FormItem>
							...
							<Select
								...
								allowNone={allowNone}
								options={huyaCDNs.map(cdn => (
									<SelectItem key={cdn} value={cdn}>
										{cdn}
									</SelectItem>
								))}
							/>
							<FormDescription>{strings.cdnDescription}</FormDescription>
							<FormMessage />
						</FormItem>
					)}
				/>
					...
					<FormField
						...
						render={({ field }) => (
							<FormItem>
								...
								<FormDescription>{strings.bitrateDescription}</FormDescription>
								<FormMessage />
							</FormItem>
						)}
					/>
