...
import {DataTableFilterOption} from "@/app/components/table/data-table";
...
export function DataTableMultiFilter<TData>({
  ...
  const [operator, setOperator ]  = React.useState(operators[0] as (typeof operators)[number] | undefined)
